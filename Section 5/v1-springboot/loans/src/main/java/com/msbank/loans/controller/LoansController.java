package com.msbank.loans.controller;
...
@Tag(
        name = "CRUD REST APIs for Loans in MSbank",
        description = "CRUD REST APIs in MSBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    public LoansController(ILoansService iLoansServicee){
        this.iLoansService = iLoansServicee;
    }
